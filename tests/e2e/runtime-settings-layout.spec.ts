...
const toolchain = JSON.parse(readFileSync(resolve(root, "runtime/toolchain-lock.json"), "utf8")) as {
...
test("long Runtime settings forms remain scrollable to their final action on Windows-sized viewports", async ({ page }) => {
