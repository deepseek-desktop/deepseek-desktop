export const messages = {
  "zh-CN": {
    ...
    about: { eyebrow: "社区版发行", title: "关于 DSH Desktop", desktopVersion: "桌面版本", harnessVersion: "Harness 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社区版", unsigned: "社区版未签名构建" },
  ...
  "zh-TW": {
    ...
    about: { eyebrow: "社群版發行", title: "關於 DSH Desktop", desktopVersion: "桌面版本", harnessVersion: "Harness 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社群版", unsigned: "社群版未簽章構建" },
  ...
  "en-US": {
    ...
    about: { eyebrow: "Community distribution", title: "About DSH Desktop", desktopVersion: "Desktop version", harnessVersion: "Harness version", nodeVersion: "Node version", channel: "Update channel", community: "Community", unsigned: "Unsigned community build" },
