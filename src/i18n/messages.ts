export const messages = {
  "zh-CN": {
    app: { name: "DeepSeek Desktop", subtitle: "本地 AI Agent 工作台" },
    ...
    onboarding: {
      welcomeTitle: "欢迎使用 DeepSeek Desktop",
  ...
  "zh-TW": {
    app: { name: "DeepSeek Desktop", subtitle: "本機 AI Agent 工作臺" },
    ...
    onboarding: {
      welcomeTitle: "歡迎使用 DeepSeek Desktop",
  ...
  "en-US": {
    app: { name: "DeepSeek Desktop", subtitle: "Local AI agent workspace" },
    ...
    onboarding: {
      welcomeTitle: "Welcome to DeepSeek Desktop",
