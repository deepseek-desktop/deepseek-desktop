...
export const messages = {
  "zh-CN": {
    ...
    about: { eyebrow: "社区版发行", title: `关于 ${appName}`, desktopVersion: "桌面版本", runtimeVersion: "Runtime 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社区版", unsigned: "社区版未签名构建" },
  ...
  "zh-TW": {
    ...
    about: { eyebrow: "社群版發行", title: `關於 ${appName}`, desktopVersion: "桌面版本", runtimeVersion: "Runtime 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社群版", unsigned: "社群版未簽章構建" },
  ...
  "en-US": {
    ...
    about: { eyebrow: "Community distribution", title: `About ${appName}`, desktopVersion: "Desktop version", runtimeVersion: "Runtime version", nodeVersion: "Node version", channel: "Update channel", community: "Community", unsigned: "Unsigned community build" },
