...
export const messages = {
  "zh-CN": {
    ...
    runtimeUpdate: {
      title: "Runtime 独立更新", currentVersion: "当前 Runtime", source: "当前来源", commit: "Runtime commit", status: "更新状态", repository: "Runtime 仓库", repositoryPlaceholder: "https://github.com/owner/deepseek-harness.git", repositoryHelp: "更换仓库即可切换 Runtime；准备失败会继续使用当前版本。", saveRepository: "保存仓库", repositorySaved: "Runtime 仓库已保存。", mode: "更新方式", channel: "Runtime 频道", pin: "版本固定", pinCurrent: "固定当前 Runtime", check: "检查 Runtime", download: "准备并等待重启切换", restoreBundled: "恢复内置 Runtime",
      sources: { bundled: "安装包内置", updated: "独立更新" },
      modes: { automatic: "自动下载，下次启动安装", notify: "发现后提醒", manual: "仅手动检查" },
      channels: { stable: "稳定版", preview: "预览版" },
      messages: { repository_timeout: "Runtime 仓库连接超时，请检查网络或代理后重试。当前版本未受影响。", idle: "尚未检查 Runtime 更新。", not_configured: "未配置 Runtime 仓库。", checking: "正在检查 Runtime 仓库。", available: "发现 Runtime {version}。", up_to_date: "当前 Runtime 已是最新版本。", downloading: "正在下载并校验 Runtime。", preparing_repository: "正在从仓库拉取、构建并验证 Runtime。", applying: "正在安装并验证新 Runtime，请稍候。", restart_to_apply: "Runtime {version} 已就绪，将在下次启动切换。", applied: "Runtime 更新已安装。", check_failed: "Runtime 仓库检查失败，当前版本未受影响。", download_failed: "Runtime 准备或校验失败，当前版本未受影响。", smoke_failed: "新 Runtime 启动验证失败，已保留当前版本。", pinned: "当前 Runtime 已固定，不会自动更新。", bundled_restored: "已恢复安装包内置 Runtime。", startup_rollback: "新 Runtime 启动失败，已自动回滚。" }
    },
    error: { unexpected: "操作失败，请查看诊断信息。", menuOpenFailed: "菜单无法打开，请重试。", settingsSaveFailed: "设置保存失败，已恢复原设置。", runtimeRepositoryFailed: "Runtime 仓库地址无效，请检查后重试。", diagnosticsExportFailed: "诊断包导出失败。", logsExportFailed: "日志导出失败。", updateCheckFailed: "Desktop 更新检查失败。", updateOpenFailed: "无法打开官方 Desktop Release 页面。", runtimeUpdateCheckFailed: "Runtime 更新检查失败，当前版本未受影响。", runtimeUpdateDownloadFailed: "Runtime 准备或校验失败，当前版本未受影响。", runtimeRestoreFailed: "恢复内置 Runtime 失败。", initializationFailed: "桌面应用初始化失败，请重新启动或查看日志。", eventChannelFailed: "状态事件通道连接失败，请刷新运行状态。" }
  },
  "zh-TW": {
    ...
    runtimeUpdate: {
      title: "Runtime 獨立更新", currentVersion: "目前 Runtime", source: "目前來源", commit: "Runtime commit", status: "更新狀態", repository: "Runtime 倉庫", repositoryPlaceholder: "https://github.com/owner/deepseek-harness.git", repositoryHelp: "更換倉庫即可切換 Runtime；準備失敗會繼續使用目前版本。", saveRepository: "儲存倉庫", repositorySaved: "Runtime 倉庫已儲存。", mode: "更新方式", channel: "Runtime 頻道", pin: "版本固定", pinCurrent: "固定目前 Runtime", check: "檢查 Runtime", download: "準備並等待重新啟動切換", restoreBundled: "還原內建 Runtime",
      sources: { bundled: "安裝包內建", updated: "獨立更新" },
      modes: { automatic: "自動下載，下次啟動安裝", notify: "發現後提醒", manual: "僅手動檢查" },
      channels: { stable: "穩定版", preview: "預覽版" },
      messages: { repository_timeout: "Runtime 倉庫連線逾時，請檢查網路或代理後重試。目前版本未受影響。", idle: "尚未檢查 Runtime 更新。", not_configured: "未設定 Runtime 倉庫。", checking: "正在檢查 Runtime 倉庫。", available: "發現 Runtime {version}。", up_to_date: "目前 Runtime 已是最新版本。", downloading: "正在下載並驗證 Runtime。", preparing_repository: "正在從倉庫拉取、構建並驗證 Runtime。", applying: "正在安裝並驗證新 Runtime，請稍候。", restart_to_apply: "Runtime {version} 已準備完成，將在下次啟動切換。", applied: "Runtime 更新已安裝。", check_failed: "Runtime 倉庫檢查失敗，目前版本未受影響。", download_failed: "Runtime 準備或驗證失敗，目前版本未受影響。", smoke_failed: "新 Runtime 啟動驗證失敗，已保留目前版本。", pinned: "目前 Runtime 已固定，不會自動更新。", bundled_restored: "已還原安裝包內建 Runtime。", startup_rollback: "新 Runtime 啟動失敗，已自動回復。" }
    },
    error: { unexpected: "操作失敗，請查看診斷資訊。", menuOpenFailed: "選單無法開啟，請重試。", settingsSaveFailed: "設定儲存失敗，已恢復原設定。", runtimeRepositoryFailed: "Runtime 倉庫位址無效，請檢查後重試。", diagnosticsExportFailed: "診斷包匯出失敗。", logsExportFailed: "日誌匯出失敗。", updateCheckFailed: "Desktop 更新檢查失敗。", updateOpenFailed: "無法開啟官方 Desktop Release 頁面。", runtimeUpdateCheckFailed: "Runtime 更新檢查失敗，目前版本未受影響。", runtimeUpdateDownloadFailed: "Runtime 準備或驗證失敗，目前版本未受影響。", runtimeRestoreFailed: "還原內建 Runtime 失敗。", initializationFailed: "桌面應用程式初始化失敗，請重新啟動或查看日誌。", eventChannelFailed: "狀態事件通道連線失敗，請重新整理執行狀態。" }
  },
  "en-US": {
    ...
    runtimeUpdate: {
      title: "Independent Runtime update", currentVersion: "Current Runtime", source: "Current source", commit: "Runtime commit", status: "Update status", repository: "Runtime repository", repositoryPlaceholder: "https://github.com/owner/deepseek-harness.git", repositoryHelp: "Change the repository to switch Runtime. The current version stays active if preparation fails.", saveRepository: "Save repository", repositorySaved: "The Runtime repository was saved.", mode: "Update behavior", channel: "Runtime channel", pin: "Version pin", pinCurrent: "Pin current Runtime", check: "Check Runtime", download: "Prepare for next launch", restoreBundled: "Restore bundled Runtime",
      ...
      messages: { repository_timeout: "The Runtime repository connection timed out. Check your network or proxy and retry. The current version was not changed.", idle: "Runtime updates have not been checked.", not_configured: "A Runtime repository is not configured.", checking: "Checking the Runtime repository.", available: "Runtime {version} is available.", up_to_date: "The current Runtime is up to date.", downloading: "Downloading and verifying the Runtime.", preparing_repository: "Fetching, building, and verifying Runtime from the repository.", applying: "Installing and verifying the new Runtime.", restart_to_apply: "Runtime {version} is ready and will switch at the next launch.", applied: "The Runtime update was installed.", check_failed: "The Runtime repository check failed. The current version was not changed.", download_failed: "Runtime preparation or verification failed. The current version was not changed.", smoke_failed: "The new Runtime failed its startup check. The current version was kept.", pinned: "The current Runtime is pinned and will not update automatically.", bundled_restored: "The bundled Runtime was restored.", startup_rollback: "The new Runtime failed to start and was rolled back automatically." }
    },
    error: { unexpected: "The operation failed. Open diagnostics for details.", menuOpenFailed: "The menu could not be opened. Try again.", settingsSaveFailed: "The settings could not be saved. The previous value was restored.", runtimeRepositoryFailed: "The Runtime repository URL is invalid. Check it and try again.", diagnosticsExportFailed: "Diagnostics could not be exported.", logsExportFailed: "Logs could not be exported.", updateCheckFailed: "The Desktop update check failed.", updateOpenFailed: "The official Desktop Release page could not be opened.", runtimeUpdateCheckFailed: "The Runtime update check failed. The current version was not changed.", runtimeUpdateDownloadFailed: "Runtime preparation or verification failed. The current version was not changed.", runtimeRestoreFailed: "The bundled Runtime could not be restored.", initializationFailed: "The desktop application could not initialize. Restart it or inspect the logs.", eventChannelFailed: "The status event channel could not connect. Refresh the runtime status." }
  }
} as const;
