export const messages = {
  "zh-CN": {
    app: { name: "DeepSeek Harness Desktop", subtitle: "本地 AI Agent 工作台" },
    ...
    onboarding: {
      welcomeTitle: "欢迎使用 DeepSeek Harness Desktop",
    ...
    about: { eyebrow: "社区版发行", title: "关于 DeepSeek Harness Desktop", desktopVersion: "桌面版本", harnessVersion: "Harness 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社区版", unsigned: "社区版未签名构建" },
  ...
  "zh-TW": {
    app: { name: "DeepSeek Harness Desktop", subtitle: "本機 AI Agent 工作臺" },
    ...
    onboarding: {
      welcomeTitle: "歡迎使用 DeepSeek Harness Desktop",
    ...
    about: { eyebrow: "社群版發行", title: "關於 DeepSeek Harness Desktop", desktopVersion: "桌面版本", harnessVersion: "Harness 版本", nodeVersion: "Node 版本", channel: "更新通道", community: "社群版", unsigned: "社群版未簽章構建" },
  ...
  "en-US": {
    app: { name: "DeepSeek Harness Desktop", subtitle: "Local AI agent workspace" },
    ...
    onboarding: {
      welcomeTitle: "Welcome to DeepSeek Harness Desktop",
    ...
    about: { eyebrow: "Community distribution", title: "About DeepSeek Harness Desktop", desktopVersion: "Desktop version", harnessVersion: "Harness version", nodeVersion: "Node version", channel: "Update channel", community: "Community", unsigned: "Unsigned community build" },
