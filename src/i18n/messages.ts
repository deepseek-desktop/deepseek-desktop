...
export const messages = {
  ...
  "zh-TW": {
    ...
    runtimeUpdate: {
      ...
      messages: { idle: "尚未檢查 Runtime 更新。", not_configured: "未設定 Runtime 倉庫。", checking: "正在檢查 Runtime 倉庫。", available: "發現 Runtime {version}。", up_to_date: "目前 Runtime 已是最新版本。", downloading: "正在下載並驗證 Runtime。", preparing_repository: "正在從倉庫拉取、構建並驗證 Runtime。", applying: "正在安裝並驗證新 Runtime，請稍候。", restart_to_apply: "Runtime {version} 已準備完成，將在下次啟動切換。", applied: "Runtime 更新已安裝。", check_failed: "Runtime 倉庫檢查失敗，目前版本未受影響。", download_failed: "Runtime 準備或驗證失敗，目前版本未受影響。", smoke_failed: "新 Runtime 啟動驗證失敗，已保留目前版本。", pinned: "目前 Runtime 已固定，不會自動更新。", bundled_restored: "已還原安裝包內建 Runtime。", startup_rollback: "新 Runtime 啟動失敗，已自動回復。" }
    },
