...
- Runtime Supervisor 支持随机端口、浏览器令牌换取会话 Cookie、带认证的 readiness / 工作区注册、有限恢复、主动停止和进程树清理；旧版无令牌 Runtime 保持兼容，仅 Runtime 制品、进程退出或启动健康失败触发回滚，配置、凭据和权限错误保持原版本并给出明确诊断。
