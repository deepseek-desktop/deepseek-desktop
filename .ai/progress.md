...
- 下一代发行版本采用 Harness 对齐的四段数字：前三段等于锁定 Harness 的正式版本，第四段是 Desktop 修订号。当前锁定 Harness `0.1.6`；`v0.1.6.1` 已进入 Tag 矩阵并完成本机 ARM64 安装与 oMLX 实测，本次配置固化候选为 `v0.1.6.2`。
...
- 新增 oMLX Qwen3.8 官方配置契约示例及暂存 Harness schema 回归；安装版已用真实模型完成对话和 Bash 工具调用，用户配置修改前保留了可恢复备份。
