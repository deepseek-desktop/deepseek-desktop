...
- 社区旧 alpha Release/Tag 已撤下，当前准备 `v0.1.5.1`；本任务交付社区代码，打包、安装验收与发布由用户指定的另一位 AI 接手。
...
- Release 正文从 CHANGELOG 的非空“未发布”段生成，发布后归档至对应版本段；`docs/releases/0.1.6.3.md` 仅保留已撤下版本的历史说明，不能作为当前下载入口。
