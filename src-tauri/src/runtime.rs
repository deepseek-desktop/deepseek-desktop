...
impl RuntimeSupervisor {
    ...
    pub fn open_runtime(&self) -> DesktopResult<()> {
        ...
        if url.scheme() != "http"
            ...
            || !is_managed_runtime_origin(&managed_url, &url)
        {
    ...
    pub fn show_settings(&self, view: &str) -> DesktopResult<()> {
        if !matches!(
            view,
            "runtime" | "diagnostics" | "update" | "desktop-update" | "about"
        ) {
    ...
    fn stop_locked(&self, manual: bool) -> DesktopResult<RuntimeStatus> {
        ...
        let surface_result = self.show_settings("runtime");
        let status = RuntimeStatus {
    ...
    fn fail(
        ...
        let _ = self.show_settings("runtime");
        let status = RuntimeStatus {
