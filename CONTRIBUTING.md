...
Thank you for helping improve DeepSeek Desktop.
...
`verify` stages the target Runtime before Rust checks. The repository-local scripts install Rust under `target/deepseek-desktop-toolchain/`; they do not modify the global Rust installation.
